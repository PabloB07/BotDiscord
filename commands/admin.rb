...
command(:kick, help_available: true, permission_message: false) do |event, user, *reason|
  ...
  command(:ban, help_available: false, permission_level: 3, permission_message: false) do |event, user, *reason|
